...
const componentsByPath = {
    ...
    "home": {name: "Home", projectId: "24FGwbPWqmgdEP3iMhrGYT" },
  
    "pricing": {name: "Pricing", projectId: "24FGwbPWqmgdEP3iMhrGYT" },
  
    "features": {name: "Features", projectId: "24FGwbPWqmgdEP3iMhrGYT" },
